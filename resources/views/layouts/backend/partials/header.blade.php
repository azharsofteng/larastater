				...
				<div class="app-header-left">
					<ul class="header-menu nav">
						...
						<li class="dropdown nav-item">
							<a href="javascript:void(0);" class="nav-link"> <i class="nav-link-icon fa fa-cog"></i>
								View site</a>
						</li>
					</ul>
				</div>
								...
								<div class="widget-content-left">
									<div class="btn-group">
										...
										<div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a  type="button" tabindex="0" class="dropdown-item"  href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Sign Out</a>
